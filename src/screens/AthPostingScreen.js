...
class AthPostingScreen extends React.Component {
  ...
  render() {
    ...
    if (this.state.progress === 1) {
      button = (
        <NeumoNextButton text="Post" onPress={this.handlePost.bind(this)} />
      );
    }
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.inner}>
            <View style={styles.header}>
              <Text style={styles.headerTitle}>Create Your Post</Text>
            </View>
            ...
            <View style={styles.contentsInfo}>
              <TextInput
                ...
                onChangeText={(text) => {
                  this.setState({ contentsCaption: text });
                }}
            ...
            <View style={styles.contentsInfo}>
              <TextInput
                ...
                onChangeText={(text) => {
                  this.setState({ contentsInfo: text });
                }}
            ...
            <View style={styles.postButtons}>{button}</View>
          </View>
        </TouchableWithoutFeedback>
      </KeyboardAvoidingView>
    );
